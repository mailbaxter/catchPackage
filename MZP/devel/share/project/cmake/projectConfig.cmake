...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/ee106/ros_ws/MZP/src/project)
  set(project_DEVEL_PREFIX /home/ee106/ros_ws/MZP/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/ee106/ros_ws/MZP/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106 <ee106@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ee106/ros_ws/MZP/src/project/${idir}'.  Ask the maintainer 'ee106 <ee106@todo.todo>' to fix it.")
    endif()
